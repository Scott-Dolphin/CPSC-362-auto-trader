...
export default function SMACrossover({ symbol }) {
    ...
    const logTrades = async () => {
        ...
        try {
            const response = await fetch('hhttp://ec2-3-138-198-12.us-east-2.compute.amazonaws.com/api/backtest_log', { //http://ec2-3-138-198-12.us-east-2.compute.amazonaws.com/api/backtest_log
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
